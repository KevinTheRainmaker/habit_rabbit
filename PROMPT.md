...
- `docs/plans/2026-03-09-mvp-carrot-balance.md` — 당근 잔액 정확성 (Task 194~196) ← 현재
...
`docs/plans/2026-03-09-mvp-carrot-balance.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-09-mvp-carrot-balance.md`의 Task 194~196이 모두 완료되면:
