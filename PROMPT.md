...
- `docs/plans/2026-03-07-mvp-auth-providers.md` — 인증/Provider 계획 (Task 16~20) ← 현재
...
`docs/plans/2026-03-07-mvp-auth-providers.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-07-mvp-auth-providers.md`의 Task 16~20이 모두 완료되면:
