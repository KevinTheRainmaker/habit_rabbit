...
- `docs/plans/2026-03-09-mvp-final.md` — MVP 파이널 (Task 108~111) ← 현재
...
`docs/plans/2026-03-09-mvp-final.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-09-mvp-final.md`의 Task 108~111이 모두 완료되면:
