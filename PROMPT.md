...
- `docs/plans/2026-03-07-mvp-usecases.md` — 유스케이스 계획 (Task 12~15) ← 현재
...
`docs/plans/2026-03-07-mvp-usecases.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-07-mvp-usecases.md`의 Task 12~15이 모두 완료되면:
