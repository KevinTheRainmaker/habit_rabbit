...
- `docs/plans/2026-03-09-mvp-blur-wiring.md` — 블러 연결 + 온보딩 스킵 + 알림 게이트 (Task 154~157) ← 현재
...
`docs/plans/2026-03-09-mvp-blur-wiring.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-09-mvp-blur-wiring.md`의 Task 154~157이 모두 완료되면:
