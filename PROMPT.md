...
- `docs/plans/2026-03-09-mvp-mission-autocheck.md` — 미션 자동 달성 (Task 203~205) ← 현재
...
`docs/plans/2026-03-09-mvp-mission-autocheck.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-09-mvp-mission-autocheck.md`의 Task 203~205이 모두 완료되면:
