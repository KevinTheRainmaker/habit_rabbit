...
- `docs/plans/2026-03-09-mvp-wiring.md` — MVP 와이어링 (Task 112~115) ← 현재
...
`docs/plans/2026-03-09-mvp-wiring.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-09-mvp-wiring.md`의 Task 112~115이 모두 완료되면:
