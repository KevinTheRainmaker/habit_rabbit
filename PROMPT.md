...
- `docs/plans/2026-03-07-mvp-delete-habit.md` — 삭제 UI + Hive 영속성 (Task 39~43) ← 현재
...
`docs/plans/2026-03-07-mvp-delete-habit.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-07-mvp-delete-habit.md`의 Task 39~43이 모두 완료되면:
