...
- `docs/plans/2026-03-08-mvp-customization.md` — 꾸미기 시스템 (Task 84~88) ← 현재
...
`docs/plans/2026-03-08-mvp-customization.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-08-mvp-customization.md`의 Task 84~88이 모두 완료되면:
