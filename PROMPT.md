...
- `docs/plans/2026-03-07-mvp-add-habit.md` — 습관 추가 (Task 35~38) ← 현재
...
`docs/plans/2026-03-07-mvp-add-habit.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-07-mvp-add-habit.md`의 Task 35~38이 모두 완료되면:
