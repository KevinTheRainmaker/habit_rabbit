...
- `docs/plans/2026-03-08-mvp-polish.md` — MVP 폴리시 (Task 104~107) ← 현재
...
`docs/plans/2026-03-08-mvp-polish.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-08-mvp-polish.md`의 Task 104~107이 모두 완료되면:
