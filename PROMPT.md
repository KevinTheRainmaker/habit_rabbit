...
- `docs/plans/2026-03-08-mvp-integration.md` — MVP 통합 연결 (Task 100~103) ← 현재
...
`docs/plans/2026-03-08-mvp-integration.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-08-mvp-integration.md`의 Task 100~103이 모두 완료되면:
