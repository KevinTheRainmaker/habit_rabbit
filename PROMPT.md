...
- `docs/plans/2026-03-09-mvp-onboarding-polish.md` — 온보딩 폴리시 (Task 142~144) ← 현재
...
`docs/plans/2026-03-09-mvp-onboarding-polish.md`에서 **가장 낮은 번호의 미완료 Task**를 찾아라.
...
`docs/plans/2026-03-09-mvp-onboarding-polish.md`의 Task 142~144이 모두 완료되면:
